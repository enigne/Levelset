...
\begin{center}
    ...
    {\includegraphics[width=.5\textwidth]{rectangle.pdf}};
    \node[inner sep=0pt] at (0, -3.2) {(a)};
    
    \node[inner sep=0pt] (b) at (7,0)
    {\includegraphics[width=.5\textwidth]{semicircle.pdf}};
    \node[inner sep=0pt] at (7, -3.2) {(b)};
	\end{tikzpicture}
\end{center}
\end{document} 
