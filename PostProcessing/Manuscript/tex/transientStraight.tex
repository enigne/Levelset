...
\begin{center}
	\begin{tikzpicture}
		...
		{\includegraphics[width=.5\textwidth]{../Figures/rectangle_parabola_1000_all.pdf}};
		\node[inner sep=0pt] at (-1.8, -3) {(c)};

		\node[inner sep=0pt] (d) at (6.4,-4.6)
		{\includegraphics[width=.5\textwidth]{../Figures/rectangle_parabola_5000_all.pdf}};
		\node[inner sep=0pt] at (4.6, -3) {(d)};

		\node[inner sep=0pt] (e) at (0,-9.2)
		{\includegraphics[width=.5\textwidth]{../Figures/rectangle_triangle_1000_all.pdf}};
		\node[inner sep=0pt] at (-1.8, -7.6) {(e)};

		\node[inner sep=0pt] (f) at (6.4,-9.2)
		{\includegraphics[width=.5\textwidth]{../Figures/rectangle_triangle_5000_all.pdf}};
