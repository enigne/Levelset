...
\begin{center}
    ...
    \footnotesize
        ...
        {\includegraphics[width=.5\textwidth]{../Figures/semicircle_200_sin_t_1000.pdf}};
        \node[inner sep=0pt] at (-2, 1.6) {(a)};
        
        \node[inner sep=0pt] (b) at (6.4,-0.2)
        {\includegraphics[width=.48\textwidth, trim=0 0 0 15, clip]{../Figures/semicircle_200_sin_t_1000_all.pdf}};
